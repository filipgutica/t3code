...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.workbenchGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.workbenchCreateProject]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchUpdateProject]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchCreateEpic]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchUpdateEpic]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.workbenchUnlinkAssignment]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchReplaceAssignment]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchPrepareTicketWorkspace]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchReleaseTicketWorkspace]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.workbenchJiraGetBoardConfiguration]: AuthOrchestrationOperateScope,
  [WS_METHODS.workbenchJiraCreateBinding]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.workbenchJiraMigrateLocalTickets]: AuthOrchestrationOperateScope,
