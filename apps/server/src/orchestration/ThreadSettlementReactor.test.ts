...
describe("storage cleanup", () => {
  ...
  for (const protection of [
    ...
    "policy-disabled",
    "policy-extended",
    "ticket-worktree-idle",
    "deleted-ticket-worktree",
    "workbench-prefix",
    "files-disabled",
    "files-extended",
  ] as const) {
    it.effect(
      ...
      () =>
        Effect.gen(function* () {
          ...
          const worktreePath =
            protection === "ticket-worktree-idle" || protection === "deleted-ticket-worktree"
              ? path.join(config.worktreesDir, "workbench", "ticket", "primary")
              : protection === "workbench-prefix"
                ? path.join(config.worktreesDir, "workbench-legacy", "feature")
                : path.join(config.worktreesDir, "feature");
